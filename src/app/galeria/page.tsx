    ...
    <div className="min-h-screen bg-[#F1F1F1] p-4 sm:p-8">
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-6 sm:mb-10 gap-3">
        <div className="flex-1 flex items-center">
          <div
            className="bg-[#E9E9E9] flex items-center px-3 py-2 min-h-[45px] w-full max-w-xl"
            style={{ boxShadow: '2px 4px 6px #e0e0e0' }}
          >
            <button
              type="button"
            ...
            >
              ...
              />
              <span className="ml-3 text-[#22345A] font-medium text-base sm:text-lg truncate">
            ...
            {!isColaborador && (
              <Link href="/expediente/nuevo" className="flex-shrink-0 ml-2">
                <button className="flex items-center justify-center hover:scale-105 transition-transform">
                  <Image
                    src="/imagenes/galeria/addAnimal.svg"
                    alt="nuevo"
                    width={32}
                    height={32}
                  />
        ...
        <div className="w-full sm:w-96 relative sm:ml-8">
          <Image
            src="/imagenes/galeria/buscar.svg"
            alt="buscar"
            width={20}
            height={20}
      ...
      <div
        className="bg-[#E8E8E8] rounded-2xl p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-y-8 justify-items-center"
        style={{ boxShadow: '2px 4px 6px #e0e0e0' }}
      >
        {cargando ? (
